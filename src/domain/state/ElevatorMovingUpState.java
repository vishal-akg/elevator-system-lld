...
public class ElevatorMovingUpState implements ElevatorState{

    public ElevatorMovingUpState(ElevatorCar elevatorCar, Integer floorToServe) {
    ...
    public void move(ElevatorCar elevatorCar) {
        System.out.println("Elevator car already moving up");
    }
}
